...
I am Niloufar Eshghi, a Computer Engineering graduate with a strong passion for Machine Learning and Data Science. I am based in Toronto, ON. With a GPA of 3.7, I obtained my Bachelor's degree in Computer Engineering from Amirkabir University of Technology (Tehran Polytechnic) in January 2023.
...
I also have practical industry experience as an HR Data Analyst CO-OP at Tapsell. I streamlined the recruitment process by constructing and administering a robust data pipeline with SQL, resulting in a 10% decrease in processing time. By scrubbing existing human resources data with SQL and Excel, I improved data accuracy and accessibility by 5%. Furthermore, I developed a web-based system for employee onboarding using Python (Django), reducing onboarding time by 15%.

In my projects, I have demonstrated my proficiency in data analysis and machine learning techniques. For instance, I [classified patients to predict their risk of diabetes using data mining methods](https://github.com/niloufareshghi/Data-Mining-Course/blob/main/Diabetes_Classification.ipynb) and developed a [search engine to retrieve news articles based on user queries](https://github.com/niloufareshghi/Search-Engine). I have also worked on projects involving pattern recognition and [database design](https://github.com/niloufareshghi/PictoGallery), showcasing my skills in Python, SQL, and data visualization using tools like Scikit-Learn, Matplotlib, Numpy, and Pandas.

I am dedicated, detail-oriented, and thrive in collaborative environments. My passion for continuous learning and my ability to adapt quickly make me well-suited for challenging projects in Machine Learning and Data Science.
